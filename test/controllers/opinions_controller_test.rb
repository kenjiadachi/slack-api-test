...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { name: @opinion.name, opinion: @opinion.opinion } }
    end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { name: @opinion.name, opinion: @opinion.opinion } }
